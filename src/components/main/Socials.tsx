  ...
  return (
    <div className="w-full bg-main-blue py-3 sm:py-5 tb:py-6 2xl:py-8">
      <div className="mx-auto w-full max-w-[500px] space-y-5 text-white sm:space-y-4 xl:max-w-[600px]">
        ...
        <div className="flex w-full items-center gap-1 font-medium max-sm:flex-col sm:gap-6 md:gap-8 lg:gap-10 justify-center">
          <div
            className={`flex items-center gap-8  sm:justify-center`}
          ...
          {socialsData.map((item, i) => {
            if (!item.address) return;
            return (
              <p key={i} className=" sm:text-center">
